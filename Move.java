public class Move
{
    ...
    private void castle()
    {
        ...
        //will never be null because all castline moves follow these rules. Didn't want an else statement becaues I wanted
    ...
    private boolean castleIsLegal()
    {
        //FOR SOME REASON I CANNOT REPLACE THE FIRST CONDITION WITH PUTS KING INTO CHECK METHOD... IDK WHY THO
    ...
    private boolean putsKingIntoCheck()
    {
        ...
        //all I do is go from the king's square, and then just check all around it for pieces of the opposite color
